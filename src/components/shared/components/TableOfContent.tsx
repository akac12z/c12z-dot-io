    ...
    <section className="flex flex-col justify-start items-start text-left w-full max-w-2xl mb-6">
      <div className="relative " ref={tocRef}>
        <button
          ...
          className="flex items-center text-cz-text-headers-dark text-sm cursor-pointer"
        >
          Tabla de Contenidos
          <span
        ...
        {isVisible && (
          <div className="backdrop-blur-lg border border-cz-text-relax-dark p-1 z-10 overflow-y-auto absolute w-72 xs:w-96 left-0 pt-4 rounded-tr-lg rounded-br-lg rounded-bl-lg">
            <ul>
