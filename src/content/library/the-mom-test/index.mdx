...
backlog: upload
buyItOnAmazon:
  spain: https://www.amazon.es/Mom-Test-Customers-Business-Everyone/dp/B08745N1QW/ref=sr_1_2?crid=4OWJZEZVKPWJ&dib=eyJ2IjoiMSJ9.qpnVOObHDwKlehSdFKbIzNvf_jRD4PM4g4mv3pErmd2P2t0lguT75Wso6Tw44i7h1Y8UpwSRKV-KrgwZFAD6PL5vUb6QpqiNXdqdsoKCm7aFRJjAwi5pSDtRt65pY8aZ.cLuU00n0VPv4fPE1ZFhUkHfIRI5j7OC-33wrumYquiw&dib_tag=se&keywords=the+mom+test
---

import OwnThoughts from "../../../components/common/ui/content/OwnThoughts.astro";

<OwnThoughts first_paragraph="en este formato te vas a encontrar mis comentarios sobre el libro The Mom Test y alguna que otra cosa interesante. he modificado algunas cosas para poder entenderlas mejor y que tengan una mejor narrativa entre ellas y sea más sencillo leerlo." />

<OwnThoughts first_paragraph="este libro te da una perspectiva sobre cómo crear producto. la premisa es 'no tienes ni puta idea de lo que tu posible usuario quiere. investiga y ya construirás cuando sepas más.'" />
...
<OwnThoughts
	first_paragraph="tienes que interiorizar qué es lo que ha pasado dejando a un lado tu ego. no te vale de nada pensar 'esa persona es idiota y no sabe de lo que habla'. sé crítico e imparcial contigo mismo/a e intenta sacar enseñanzas de la conversación y reflexiona sobre qué ha pasado."
	second_paragraph="no guardes rencor. recuerda que no están en contra de tu persona, sino de aquello que crees que les hace falta y que posiblemente no han entendido o que en el mejor de los casos, si lo han entendido y por tanto, no son tu cliente y no pierdes el tiempo."
/>
...
<OwnThoughts
	first_paragraph="aquí me salgo un poco de este libro y voy al de Chris Voss, _Never Split The Difference_ donde explica la regla del etiquetado."
	second_paragraph="las ideas son: percibir las emociones de la persona y preguntarle por ellas a través de frases que podrían empezar con: 'Da la sensación de que...', 'Parece que...' o 'Suena a que...' y después, añades la emoción que consideras que está teniendo."
	third_paragraph="cuando lo hagas, NUNCA las formules en primera persona ('Siento que...', 'Me da la sensación de...'). parecerá que estás opinando, juzgando y acusando cosa que te hará que se cierre y se ponga a la defensiva."
/>
...
<OwnThoughts
	first_paragraph="piensa que tú estás dispuesto a encontrar una respuesta sea como sea. estás yendo doblemente sesgado porque 1) consideras que tu producto es útil, y 2) quieres corroborar que estás en lo cierto."
	second_paragraph="estás cayendo en el sesgo de confirmación, este describe la tendencia que tienes a buscar o favorecer tendencias que confirmen tus creencias."
/>
...
<OwnThoughts first_paragraph="hay un framework, **The 4 Fits**, de Brian Balfor de Reforge, que te ayudará a pensar en relación entre tu producto, el mercado y cómo y dónde venderlo. todavía no tengo el framework en mi blog explicado pero, hasta entonces, te dejo aquí abajo el link a su ensayo.">
	<a
		class=" decoration-cz-primary pb-0 underline group hover:no-underline italic"
		target="_blank"
		title="ir al ensayo de Brian Balfor sobre los 4 Fits Growth Framework"
		rel="noopener noreferrer"
		href="https://brianbalfour.com/four-fits-growth-framework"
	>
...
<OwnThoughts
	first_paragraph="una de las cosas que más admiro de los buenos founders es que siempre están vendiendo, y muchas veces de manera sutil. cuando hablas con ellos, y más si eres su target, no sabes cómo pero te han llevado a su terreno. tienen un conocimiento profundo del problema, y no tanto de la solución, como para poder llevar una conversación a la 'zona de aprendizaje'."
	second_paragraph="su éxito que radica en que dejan de hablar de ellos y empieza a hablar su usuario de su problema. te dejo un artículo científico donde puedes ver cómo afecta a las personas hablar de sí mismos y porqué pienso que los buenos founders hacen esto:"
>
	<a
		class=" decoration-cz-primary pb-0 underline group hover:no-underline italic"
		target="_blank"
		title="ir al artículo científico sobre hablar de sí mismo en el PNAS"
		rel="noopener noreferrer"
		href="https://www.pnas.org/doi/10.1073/pnas.1202129109"
	>
...
<OwnThoughts first_paragraph="te dejo un artículo donde puedes leer más sobre Saturación de Datos de NN/Group:">
	<a
		class=" decoration-cz-primary pb-0 underline group hover:no-underline italic"
		target="_blank"
		title="ir al artículo de NN/Group sobre cuántas entrevistas necesitas"
		rel="noopener noreferrer"
		href="https://www.nngroup.com/articles/interview-sample-size/"
	>
...
<OwnThoughts
	first_paragraph="un ejemplo de esto es lo que en CrossFit llamamos Tape (para los fisios: cintas kinesiológicas). son las bandas que, en ocasiones, los fisios ponen en la zona que te han tratado para dar soporte muscular. los que hacemos CrossFit lo usamos para vendarnos los dedos para no hacernos daño con la fricción a la hora de coger las barras."
	second_paragraph="pensando fríamente, son 2 públicos parecidos. ambos relacionados con el mundo de la salud y el deporte, en ambos casos se podría decir que se usa como ayuda para moverte mejor. mundos parecidos pero 2 casos de uso totalmente distintos."
	third_paragraph="imagina si tuvieras que hacer una estrategia para vender estas cintas sin haber segmentado bien. ¿qué tipo de contenido creas? ¿qué tipo de mensaje? ¿qué tipo de enfoque? ¿qué tipo de marketing? ¿qué tipo de ventas? ¿cuántas conversaciones? un caos si no haces bien el trabajo, ¿no?"
/>
...
<OwnThoughts
	first_paragraph="e incluso sería bueno tener un apartado en tus notas donde puedas hablar acerca de cómo crees se ha sentido, su lenguaje corporal o cómo ha sido el tuyo. cualquier cosa que te ayude a mejorar y averiguar aquellas cosas que no se ven a simple vista. lo que se llama 'Cisne Negro'."
	second_paragraph="una anécdota que me pasó en una startup cuando estaba llamando a una clienta para intentar vender el producto y a su vez entender nuestro target, fue escuchar de fondo a un niño llorando. a priori, no podría significar nada pero gracias al haber pensado en esto, pudimos acotar más nuestro usuario y poder tener un mensaje más específico y tener más casos de uso relacionados a ese insight en un futuro."
	third_paragraph="con esto quiero decir que no solo busques solo responder esas preguntas. pueden haber otros insights, que no se ven y que si estás pendiente y escuchas de manera activa, te pueden dar información valiosa que no se te habría ocurrido. solo tienes que estar atento."
/>
...
<OwnThoughts
	first_paragraph="el libro que yo tengo fue publicado en 2019, lejos de AI. aunque todo lo relacionado con hacer preguntas sigue y seguirá vigente, este último apartado ha cambiado. mucho. y traigo algunas herramientas que considero útiles para hacer entrevistas."
	second_paragraph="ahora existen herramientas que pueden grabar, resumir y coger insights de las entrevistas online. pero hay una startup muy útil para hacer entrevistas offline que me voló la cabeza de lo bien integrado que está y lo fácil que es de usar, Plaud AI. no me llevo nada por nombrarla (eso quisiera yo), simplemente te intento hacer la vida más fácil teniendo entrevistas offline."
	third_paragraph="te dejo algunas tools aquí abajo de AI para hacer estas grabaciones y resúmenes (esto está escrito a 25 de Noviembre de 2025. estas son, a día de hoy, las más importantes)."
/>
