...
<OwnThoughts first_paragraph="tienes que interiorizar qué es lo que ha pasado dejando a un lado tu ego. no te vale de nada pensar 'esa persona es idiota y no sabe de lo que habla'. sé crítico e imparcial contigo mismo/a e intenta sacar enseñanzas de la conversación y reflexiona sobre qué ha pasado."
...
<OwnThoughts first_paragraph="aquí me salgo un poco de este libro y voy al de Chris Voss, _Never Split The Difference_ donde explica la regla del etiquetado."
...
<OwnThoughts first_paragraph="piensa que tú estás dispuesto a encontrar una respuesta sea como sea. estás yendo doblemente sesgado porque 1) consideras que tu producto es útil, y 2) quieres corroborar que estás en lo cierto."
...
> Si no tienes claro a quién estás vendiendo, no tienes claro qué estás vendiendo. Encuentra un problema y objetivo concreto.
...
<OwnThoughts first_paragraph="e incluso sería bueno tener un apartado en tus notas donde puedas hablar acerca de cómo crees se ha sentido, su lenguaje corporal o cómo ha sido el tuyo. cualquier cosa que te ayude a mejorar y averiguar aquellas cosas que no se ven a simple vista. lo que se llama 'Cisne Negro'."
...
<OwnThoughts first_paragraph="el libro que yo tengo fue publicado en 2019, lejos de AI. aunque todo lo relacionado con hacer preguntas sigue y seguirá vigente, este último apartado ha cambiado. mucho. y traigo algunas herramientas que considero útiles para hacer entrevistas."
